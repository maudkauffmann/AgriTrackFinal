 ...
 */
final class Version20260605152525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intrant DROP FOREIGN KEY `fk_intrant_type`');
        $this->addSql('ALTER TABLE intrant DROP FOREIGN KEY `fk_intrant_type`');
        ...
        $this->addSql('ALTER TABLE intrant ADD CONSTRAINT `fk_intrant_type` FOREIGN KEY (id_tp_intrant) REFERENCES type_intrant (id_tp_intrant) ON DELETE CASCADE');
    }
